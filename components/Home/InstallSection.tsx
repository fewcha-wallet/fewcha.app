    ...
    <div className="bg-[#000] bg-ex bg-no-repeat lg:pt-5 bg-top">
      <div className="container">
        <div className="max-w-[754px] pb-[73px] pt-[152px] md:py-[180px]  text-white mx-auto text-center">
          ...
          <a href={linkExt} target="_blank" rel="noreferrer" className="bg-[#007EFB] max-w-[186px] mx-auto p-[10px] rounded-[100px] font-medium text-[18px] leading-[120%] text-center hover:cursor-pointer hover:opacity-[0.95]">{more}</a>
        </div>
      </div>
    </div>
  );
