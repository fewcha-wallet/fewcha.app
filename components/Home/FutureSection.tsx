...
const FutureSection: React.FC = () => {
  ...
  return (
    <section className="bg-cover bg-center w-full future-section-bg h-auto md:h-[63vh]  lg:h-screen overflow-hidden bg-[#F9FCFF]">
      <div className="container mx-auto">
        <div className="max-w-[542px] lg:pt-[148px]">
          ...
          <p className="text-[#000000] w-[327px] font-normal text-[20px] leading-[153%] pt-4 pb-6 pr-[26px] md:pr-0 lg:w-auto lg:pr-[170px]">
            {description}
          </p>
